    ...
    <div>
      ...
      <div className='h-screen flex justify-center items-center -mt-16'>
        <form className='backdrop-blur bg-cyan-700/50 p-4 rounded-xl w-96'>
          <div className='text-4xl flex items-center justify-center w-full my-7'>Create Record</div>
          ...
          <label className='flex flex-col w-full p-1 -my-5'>
              ...
              <input type='text' className='w-full rounded-md h-12 border border-gray-600 placeholder:text-gray-600 p-2' placeholder='Enter Hospital Name' />
          </label>
          <label className='flex flex-col w-full p-1 -my-5'>
              {/* <p className='text-xl flex justify-start text-white'>Phone Number:</p> */}
              <input type='text' className='w-full rounded-md h-12 border border-gray-600 placeholder:text-gray-600 p-2' placeholder='Enter Doctor Name' />
          </label>

          <label className='flex flex-col w-full p-1 -my-5'>
              {/* <p className='text-xl flex justify-start text-white'>Password:</p> */}
              <input type='text' className='w-full rounded-md h-12 border border-gray-600 placeholder:text-gray-600 p-2' placeholder='Medical Advice' />
          </label>
          <label className='flex flex-col w-full p-1 -my-5'>
              {/* <p className='text-xl flex justify-start text-white'>Password:</p> */}
             <p>Documents</p>
              <input type='file' className='w-full file block text-sm text-slate-500
                    file:mr-4 file:py-2 file:px-4
                    file:rounded-full file:border-0
                    file:text-sm file:font-semibold
                    file:bg-violet-50
                    hover:file:bg-violet-100' placeholder='Prescription and Other Documents' 
          ...
          <div className='flex justify-center'>
              <button className="relative mt-5 flex justify-center items-center border border-cyan-500 w-48 py-2 text-xl overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
                  ...
                  <div><span className="relative w-full text-left text-black transition-colors duration-300 ease-in-out group-hover:text-white">Create</span>
                  </div>
              </button>
          </div>
        </form>
